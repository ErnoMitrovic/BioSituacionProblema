...
writeXStringSet(seq.aligned, file="aligned_seq.fasta")
seq.aligned <- read.alignment("virus_seq_align.fasta", format = "fasta")
...
ggmsa(virus_seq_not_align, 850, 900, color = "Chemistry_AA")
